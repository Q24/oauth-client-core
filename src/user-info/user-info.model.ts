...
export interface UserInfo {
   ...
   * unique, as discussed in Section 2.5.3.
   */
  email: string;
  /**
  ...
  /**
   * End-User's gender. Values defined by this document are female and male. Other
   ...
   * implementations have used an underscore as the separator rather than a dash,
   * for example, en_US; Relying Parties MAY choose to accept this locale syntax
   * as well.
   */
  locale: string;
  /**
